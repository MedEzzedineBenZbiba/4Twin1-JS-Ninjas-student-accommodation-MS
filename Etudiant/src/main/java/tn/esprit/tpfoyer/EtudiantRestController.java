...
public class EtudiantRestController {
    ...
    @Operation(description = "Récupérer les étudiants par ecole")
    @GetMapping("/ecole/{ecole}")
    public List<Etudiant> getEtudiantsByEcole(@PathVariable("ecole") String ecole) {
        return etudiantService.findEtudiantsByeEcole(ecole);
    }
