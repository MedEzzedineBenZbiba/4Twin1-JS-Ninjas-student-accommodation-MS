...
const Reservation = () => {
  ...
  const fetchReservations = async () => {
    try {
      const res = await axios.get('http://localhost:8090/reservation', getAuthHeader());
  ...
  const deleteReservation = async (id) => {
    try {
      await axios.delete(`http://localhost:8090/reservation/${id}`, getAuthHeader());
      fetchReservations();
    } catch (err) {
  ...
  const addReservation = async () => {
    try {
      await axios.post('http://localhost:8090/reservation', newReservation, getAuthHeader());
